...
import com.mandi.transport.TransportRequest;
...
public class TransportRequestDto {
    ...
    private String assignedVehicleModel;
    ...
    private boolean unloadingRequired;
    ...
    public static TransportRequestDto fromEntity(TransportRequest tr) {
        if (tr == null) return null;
        TransportRequestDto dto = new TransportRequestDto();
        dto.setId(tr.getId());
        if (tr.getRequester() != null) {
            dto.setRequesterId(tr.getRequester().getId());
            dto.setRequesterName(tr.getRequester().getFullName());
            dto.setRequesterPhone(tr.getRequester().getPhone());
        }
        if (tr.getAssignedVehicle() != null) {
            dto.setAssignedVehicleId(tr.getAssignedVehicle().getId());
            dto.setAssignedVehicleModel(tr.getAssignedVehicle().getModelName());
        }
        if (tr.getAssignedProvider() != null) {
            dto.setAssignedProviderId(tr.getAssignedProvider().getId());
            dto.setAssignedProviderName(tr.getAssignedProvider().getFullName());
        }
        dto.setCargoType(tr.getCargoType());
        dto.setCargoDescription(tr.getCargoDescription());
        dto.setQuantityQuintals(tr.getQuantityQuintals());
        dto.setWeightTons(tr.getWeightTons());
        dto.setPickupVillage(tr.getPickupVillage());
        dto.setPickupBlock(tr.getPickupBlock());
        dto.setPickupDistrict(tr.getPickupDistrict());
        dto.setPickupState(tr.getPickupState());
        dto.setPickupLatitude(tr.getPickupLatitude());
        dto.setPickupLongitude(tr.getPickupLongitude());
        dto.setDestinationVillage(tr.getDestinationVillage());
        dto.setDestinationBlock(tr.getDestinationBlock());
        dto.setDestinationDistrict(tr.getDestinationDistrict());
        dto.setDestinationState(tr.getDestinationState());
        dto.setDestinationLatitude(tr.getDestinationLatitude());
        dto.setDestinationLongitude(tr.getDestinationLongitude());
        dto.setRequiredDate(tr.getRequiredDate());
        dto.setStartTime(tr.getStartTime());
        dto.setEndTime(tr.getEndTime());
        dto.setPreferredVehicleType(tr.getPreferredVehicleType());
        dto.setRequiredCapacityTons(tr.getRequiredCapacityTons());
        dto.setDriverRequired(tr.isDriverRequired());
        dto.setLoadingRequired(tr.isLoadingRequired());
        dto.setUnloadingRequired(tr.isUnloadingRequired());
        dto.setBudgetAmount(tr.getBudgetAmount());
        dto.setAgreedPrice(tr.getAgreedPrice());
        dto.setCounterPrice(tr.getCounterPrice());
        dto.setCounterNotes(tr.getCounterNotes());
        dto.setStatus(tr.getStatus());
        dto.setSpecialInstructions(tr.getSpecialInstructions());
        dto.setContactPhone(tr.getContactPhone());
        dto.setLinkedBookingId(tr.getLinkedBookingId());
        dto.setLinkedCropOrderId(tr.getLinkedCropOrderId());
        return dto;
    }
    ...
    public String getAssignedVehicleModel() { return assignedVehicleModel; }
    public void setAssignedVehicleModel(String assignedVehicleModel) { this.assignedVehicleModel = assignedVehicleModel; }
