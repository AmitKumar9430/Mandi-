    ...
    <div className="min-h-screen bg-stone-900 text-stone-100 font-sans pb-16">
      ...
      <div className="bg-stone-950/90 border-b border-stone-800/80 px-4 sm:px-6 lg:px-8 py-2.5 shadow-md">
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-start lg:items-center justify-between gap-3">
          ...
          <div className="flex items-center space-x-3">
            <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-amber-500 via-emerald-600 to-pine-800 text-white flex items-center justify-center font-black text-xl shadow-md border border-amber-400 flex-shrink-0">
              🌾
            </div>
            <div>
              <div className="flex items-center space-x-2">
                ...
                <span className="bg-amber-400/20 text-amber-300 border border-amber-400/50 text-[10px] font-black px-2 py-0.5 rounded-full uppercase tracking-wider">
                  🌾 Kisan Producer
                </span>
                <span className="bg-emerald-500/20 text-emerald-300 border border-emerald-500/40 text-[9px] font-bold px-1.5 py-0.5 rounded-full flex items-center space-x-1">
          ...
          <div className="flex items-center space-x-2 w-full lg:w-auto justify-end">
            ...
            <button
              ...
              className="flex items-center space-x-1.5 bg-gradient-to-r from-emerald-500 to-pine-700 hover:from-emerald-400 text-white px-3.5 py-1.5 rounded-xl text-xs font-black shadow border border-emerald-400 transition"
      ...
      {actionSuccess && (
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-4">
          <div className="bg-emerald-900/90 border-2 border-emerald-400 text-emerald-100 p-4 rounded-2xl flex items-center justify-between shadow-xl animate-fadeIn">
        ...
        {activeTab === 'bazaar' && (
          <div className="space-y-8">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
              ...
              <div className="lg:col-span-7 bg-stone-950 rounded-3xl p-6 border-2 border-stone-800 shadow-xl space-y-4">
                <div className="flex items-center justify-between border-b border-stone-800 pb-3">
                  ...
                  <span className="bg-emerald-950 text-emerald-400 text-[10px] font-mono font-bold px-2.5 py-1 rounded-full border border-emerald-500/40 animate-pulse">
                    ● Live Today
                  </span>
                </div>
                  ...
                  <table className="w-full text-left text-xs">
                    <thead>
                      <tr className="border-b border-stone-800 text-stone-400 font-bold uppercase text-[10px]">
                        <th className="py-2.5 px-2">फसल (Crop)</th>
                        <th className="py-2.5 px-2">मंडी (Mandi Yard)</th>
                        <th className="py-2.5 px-2">मौजूदा भाव (Current)</th>
                        <th className="py-2.5 px-2">सरकारी MSP</th>
                        <th className="py-2.5 px-2 text-right">ट्रेंड (Trend)</th>
                      </tr>
                    </thead>
                      ...
                      {mandiRates.map((r, idx) => (
                        <tr key={idx} className="hover:bg-stone-900/60 transition">
                          <td className="py-3 px-2">
                            <span className="font-bold text-white block">{r.crop}</span>
                            <span className="text-[10px] text-stone-300 font-mono">{r.variety}</span>
                          </td>
                          <td className="py-3 px-2 text-stone-300">{r.mandi}</td>
                          <td className="py-3 px-2 font-mono font-black text-emerald-400 text-sm">
                            ₹{r.currentPrice} <span className="text-[10px] text-stone-300 font-normal">/qtl</span>
                          </td>
                          <td className="py-3 px-2 font-mono text-stone-400">
                            {r.msp > 0 ? `₹${r.msp}` : '—'}
                          </td>
                          <td className="py-3 px-2 text-right">
                            <span className={`inline-block font-mono text-[11px] font-black px-2 py-0.5 rounded ${
                              r.trendDirection === 'UP' ? 'bg-emerald-950 text-emerald-400 border border-emerald-500/30' : 'bg-rose-950 text-rose-400 border border-rose-500/30'
                            }`}>
              ...
              <div className="lg:col-span-5 bg-stone-950 rounded-3xl p-6 border-2 border-stone-800 shadow-xl space-y-4 flex flex-col justify-between">
                <div className="space-y-3">
                  ...
                  <div className="space-y-3 max-h-[380px] overflow-y-auto pr-1 scrollbar-thin">
                    {demandBoard.map((d) => (
                      <div key={d.id} className="p-3.5 rounded-2xl bg-stone-900 border border-stone-800 hover:border-amber-500/50 transition space-y-2">
                        <div className="flex items-start justify-between">
                          <div>
                            <span className="font-black text-white text-xs block">{d.buyerName}</span>
                            <span className="text-[10px] text-amber-400 font-bold uppercase">{d.cropRequired} • {d.quantityQuintals} Qtl Required</span>
                          </div>
                          <span className="font-mono font-black text-emerald-400 text-xs bg-emerald-950 px-2 py-0.5 rounded border border-emerald-500/30">
                        ...
                        <div className="flex items-center space-x-2 pt-1">
                          <button
                            ...
                            className="flex-1 py-1.5 bg-amber-500 hover:bg-amber-400 text-stone-950 font-black text-xs rounded-xl transition flex items-center justify-center space-x-1"
                          >
                          ...
                          <a
                            ...
                            className="p-1.5 bg-stone-800 hover:bg-stone-700 text-emerald-400 rounded-xl border border-stone-700 transition"
                            title="Direct Call"
                          >
                ...
                <div className="p-3 bg-stone-900/80 rounded-2xl border border-stone-800 text-[11px] text-stone-400 flex items-center justify-between">
            ...
            <div className="bg-stone-950 rounded-3xl p-6 border-2 border-stone-800 shadow-xl space-y-4">
              <div className="flex items-center justify-between border-b border-stone-800 pb-3 flex-wrap gap-2">
                ...
                <button
                  onClick={() => setShowPostCropModal(true)}
                  className="bg-emerald-600 hover:bg-emerald-500 text-white px-3.5 py-1.5 rounded-xl font-bold text-xs flex items-center space-x-1.5 shadow transition"
                >
              ...
              {myCrops.length === 0 ? (
                <div className="py-12 text-center space-y-3">
                  ...
                  <button
                    onClick={() => setShowPostCropModal(true)}
                    className="bg-emerald-600 text-white px-4 py-2 rounded-xl text-xs font-bold shadow hover:bg-emerald-500"
                  >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                  {myCrops.map((c) => (
                    <div key={c.id} className="p-4 bg-stone-900 rounded-2xl border border-stone-800 hover:border-emerald-500/40 transition space-y-3">
                      <div className="flex items-start justify-between">
                        <div>
                      ...
                      <div className="grid grid-cols-2 gap-2 text-xs bg-stone-950 p-2.5 rounded-xl border border-stone-800">
                        <div>
                          <span className="text-[10px] text-stone-300 block">कुल मात्रा (Quantity)</span>
                          <span className="font-bold text-white font-mono">{c.quantityQuintals} Quintals</span>
                        </div>
                        <div>
                          <span className="text-[10px] text-stone-300 block">अपेक्षित भाव (Price)</span>
                          <span className="font-bold text-emerald-400 font-mono">₹{c.expectedPricePerQuintal} /Qtl</span>
                        </div>
                      </div>
        ...
        {activeTab === 'services' && (
          <div className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="bg-stone-950 rounded-3xl p-6 border-2 border-stone-800 shadow-xl space-y-4 flex flex-col justify-between">
                <div className="space-y-3">
                  ...
                  <div className="bg-stone-900 p-3 rounded-2xl border border-stone-800 space-y-1 text-xs text-stone-300">
                    <p className="flex items-center justify-between">
                      <span>Available Carriers in {distanceRadius}km:</span>
                      <span className="font-mono font-bold text-emerald-400">8 Verified</span>
                    </p>
                    <p className="flex items-center justify-between">
                      <span>Average Freight Rate:</span>
                      <span className="font-mono text-amber-400">₹35 - ₹50 /km</span>
                    </p>
                  </div>
                </div>
                <button
                  onClick={() => setShowTransportModal(true)}
                  className="w-full py-2.5 bg-gradient-to-r from-amber-500 to-amber-600 hover:from-amber-400 hover:to-amber-500 text-stone-950 font-black rounded-xl text-xs shadow-lg transition"
                >
              ...
              <div className="bg-stone-950 rounded-3xl p-6 border-2 border-stone-800 shadow-xl space-y-4 flex flex-col justify-between">
                <div className="space-y-3">
                  <div className="w-12 h-12 rounded-2xl bg-emerald-500/20 text-emerald-400 flex items-center justify-center font-black text-2xl border border-emerald-500/40">
                    🚜
                  </div>
                  <div>
                    <h3 className="text-lg font-black text-white">
                  ...
                  <div className="bg-stone-900 p-3 rounded-2xl border border-stone-800 space-y-1 text-xs text-stone-300">
                    <p className="flex items-center justify-between">
                      ...
                      <span className="font-mono font-bold text-emerald-400">14 Units</span>
                    </p>
                    <p className="flex items-center justify-between">
                      <span>Harvester Rate:</span>
                      <span className="font-mono text-amber-400">₹1,800 - ₹2,200 /acre</span>
                    </p>
                  </div>
                </div>
                <button
                  onClick={() => setShowMachineryModal(true)}
                  className="w-full py-2.5 bg-gradient-to-r from-emerald-500 to-pine-600 hover:from-emerald-400 hover:to-pine-500 text-white font-black rounded-xl text-xs shadow-lg transition"
                >
              ...
              <div className="bg-stone-950 rounded-3xl p-6 border-2 border-stone-800 shadow-xl space-y-4 flex flex-col justify-between">
                <div className="space-y-3">
                  <div className="w-12 h-12 rounded-2xl bg-blue-500/20 text-blue-400 flex items-center justify-center font-black text-2xl border border-blue-500/40">
                    👥
                  </div>
                  <div>
                    <h3 className="text-lg font-black text-white">
                  ...
                  <div className="bg-stone-900 p-3 rounded-2xl border border-stone-800 space-y-1 text-xs text-stone-300">
                    <p className="flex items-center justify-between">
                      ...
                      <span className="font-mono font-bold text-emerald-400">6 Available</span>
                    </p>
                    <p className="flex items-center justify-between">
                      <span>Standard Daily Wage:</span>
                      <span className="font-mono text-amber-400">₹450 - ₹550 /day</span>
                    </p>
                  </div>
                </div>
                <button
                  onClick={() => setShowLabourModal(true)}
                  className="w-full py-2.5 bg-gradient-to-r from-blue-600 to-indigo-700 hover:from-blue-500 hover:to-indigo-600 text-white font-black rounded-xl text-xs shadow-lg transition"
                >
          ...
          <div className="space-y-6">
            <div className="bg-stone-950 rounded-3xl p-6 border-2 border-stone-800 shadow-xl space-y-4">
              ...
              <div className="space-y-4">
                {mockOrders.map((ord) => (
                  <div key={ord.id} className="p-5 bg-stone-900 rounded-2xl border border-stone-800 space-y-4">
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 border-b border-stone-800 pb-3">
                      <div>
                        <div className="flex items-center space-x-2">
                          <span className="font-mono font-black text-amber-400 text-sm">{ord.id}</span>
                          <span className="text-white font-black text-sm">• {ord.crop}</span>
                        </div>
                        <p className="text-xs text-stone-400 mt-0.5">
                          Buyer: <span className="text-white font-semibold">{ord.buyer}</span>
                        </p>
                      </div>
                      <div className="flex items-center space-x-2">
                        ...
                        <span className="bg-emerald-600 text-white font-mono font-black text-xs px-2.5 py-1 rounded-full">
                          {ord.totalAmount}
                        </span>
                      </div>
                    </div>
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 text-center text-xs">
                      <div className="p-2.5 rounded-xl bg-emerald-950/60 border border-emerald-500/50 text-emerald-300 font-bold">
                        ✓ 1. Order Accepted
                      </div>
                      <div className={`p-2.5 rounded-xl border font-bold ${
                        ord.status === 'FARMER_ACCEPTED' ? 'bg-amber-950/60 border-amber-500/50 text-amber-300 animate-pulse' : 'bg-emerald-950/60 border-emerald-500/50 text-emerald-300'
                      }`}>
                        {ord.status === 'FARMER_ACCEPTED' ? '⏳ 2. Packing / Staging' : '✓ 2. Packed & Ready'}
                      </div>
                      <div className={`p-2.5 rounded-xl border font-bold ${
                        ord.status === 'COMPLETED' ? 'bg-emerald-950/60 border-emerald-500/50 text-emerald-300' : 'bg-stone-950 border-stone-800 text-stone-300'
                      }`}>
                        {ord.status === 'COMPLETED' ? '✓ 3. Transport Delivered' : '🚚 3. Transport Pickup'}
                      </div>
                      <div className={`p-2.5 rounded-xl border font-bold ${
                        ord.paymentStatus === 'PAID_DIRECT' ? 'bg-emerald-950/60 border-emerald-500/50 text-emerald-300' : 'bg-stone-950 border-stone-800 text-stone-300'
                      }`}>
                        {ord.paymentStatus === 'PAID_DIRECT' ? '✓ 4. Payment Settled' : '💳 4. Final Settlement'}
                      </div>
                    </div>

                    <div className="flex flex-wrap items-center justify-between text-xs text-stone-400 bg-stone-950 p-3 rounded-xl border border-stone-800/80 gap-2">
                      <div className="flex items-center space-x-2">
                        <Truck className="w-4 h-4 text-emerald-400" />
                        <span>Transporter: <span className="text-white font-semibold">{ord.transporter}</span></span>
                      </div>
                      <span className="font-mono text-stone-300">{ord.dispatchDate}</span>
                    </div>
                  </div>
                ))}
              </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
              ...
              <div className="lg:col-span-6 bg-stone-950 rounded-3xl p-6 border-2 border-stone-800 shadow-xl space-y-4">
                ...
                <div className="p-4 rounded-2xl bg-emerald-950/60 border border-emerald-500/40 space-y-1.5">
                  <span className="text-[10px] font-black text-emerald-300 uppercase tracking-wider flex items-center space-x-1">
                ...
                <div className="grid grid-cols-5 gap-2 text-center text-xs">
                  {(weatherData?.forecast || []).map((f, idx) => (
                    <div key={idx} className="p-2.5 rounded-xl bg-stone-900 border border-stone-800 space-y-1">
                      <span className="text-[10px] text-stone-300 font-bold block">{f.day}</span>
                      <span className="text-xl block">{f.icon}</span>
                      <span className="text-[10px] font-mono text-white block">{f.temp}</span>
                      <span className="text-[9px] font-mono text-blue-400 block">💧 {f.rain}</span>
                    </div>
                  ))}
                </div>
              </div>
                ...
                <div className="space-y-3">
                  ...
                  <div className="space-y-2 text-xs">
                    <div className="p-3 rounded-2xl bg-stone-900 border border-stone-800 flex items-center justify-between">
                      <span className="text-stone-300">⚡ Burnt Transformer / Voltage Low</span>
                      <span className="font-mono text-amber-400 font-bold">48h SLA</span>
                    </div>
                    <div className="p-3 rounded-2xl bg-stone-900 border border-stone-800 flex items-center justify-between">
                      <span className="text-stone-300">🌊 Canal Water Tail-End Shortage</span>
                      <span className="font-mono text-blue-400 font-bold">24h SLA</span>
                    </div>
                    <div className="p-3 rounded-2xl bg-stone-900 border border-stone-800 flex items-center justify-between">
                      <span className="text-stone-300">🚛 Mandi Gate Weighbridge Delay</span>
                      <span className="font-mono text-emerald-400 font-bold">Same Day</span>
                    </div>
                  </div>
                </div>
            ...
            <div className="bg-stone-950 rounded-3xl p-6 border-2 border-stone-800 shadow-xl space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                {[
                  ...
                  <div key={idx} className="p-4 bg-stone-900 rounded-2xl border border-stone-800 space-y-2 flex flex-col justify-between">
                    <div>
                      <h4 className="font-black text-white text-xs">{s.title}</h4>
                      <span className="font-mono text-emerald-400 text-xs font-bold block mt-1">{s.benefit}</span>
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noreferrer"
                      className="inline-block mt-3 text-center py-1.5 bg-stone-800 hover:bg-stone-700 text-emerald-300 font-bold text-xs rounded-xl border border-stone-700 transition"
                    >
            ...
            <div className="bg-stone-950 rounded-3xl p-6 border-2 border-stone-800 shadow-xl space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                {storageFacilities.map((st) => (
                  <div key={st.id} className="p-4 bg-stone-900 rounded-2xl border border-stone-800 space-y-3 flex flex-col justify-between">
                    <div className="space-y-2">
                      <div className="flex items-start justify-between">
                        <div>
                          <h4 className="font-black text-white text-xs">{st.name}</h4>
                          <span className="text-[10px] text-amber-400 font-bold">{st.facilityType}</span>
                        </div>
                        <span className="bg-stone-950 font-mono text-[10px] text-emerald-400 px-2 py-0.5 rounded border border-stone-800">
                          {st.distanceKm} km
                        </span>
                      </div>

                      <div className="bg-stone-950 p-2.5 rounded-xl border border-stone-800 text-xs space-y-1 font-mono">
                        <div className="flex justify-between text-stone-300">
                          <span>Available:</span>
                          <span className="font-bold text-white">{st.availableCapacityMT} MT</span>
                        </div>
                        <div className="flex justify-between text-stone-300">
                          <span>Rate:</span>
                          <span className="text-emerald-400 font-bold">₹{st.ratePerQuintalMonth} /qtl/mo</span>
                        </div>
                      </div>
                    ...
                    <a
                      ...
                      className="w-full py-2 bg-stone-800 hover:bg-stone-700 text-white font-bold text-xs rounded-xl flex items-center justify-center space-x-1.5 transition border border-stone-700"
                    >
            ...
            <div className="bg-stone-950 rounded-3xl p-6 border-2 border-stone-800 shadow-xl space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {agriServices.map((srv) => (
                  <div key={srv.id} className="p-4 bg-stone-900 rounded-2xl border border-stone-800 flex items-center justify-between gap-4">
                    <div className="space-y-1 min-w-0">
                      <div className="flex items-center space-x-2">
                        <h4 className="font-black text-white text-xs truncate">{srv.name}</h4>
                        <span className="text-[9px] bg-emerald-950 text-emerald-400 px-1.5 py-0.5 rounded font-mono font-bold">
                          ⭐ {srv.rating}
                        </span>
                      </div>
                      <span className="text-[11px] text-amber-400 font-bold block truncate">{srv.category}</span>
                      <p className="text-[11px] text-stone-400 truncate">📍 {srv.address}</p>
                      <p className="text-[10px] text-stone-300 line-clamp-1">{srv.services}</p>
                    </div>
      ...
      {showPostCropModal && (
        <div className="fixed inset-0 z-50 bg-black/80 flex items-center justify-center p-4 backdrop-blur-sm overflow-y-auto">
          <div className="bg-stone-950 border-2 border-emerald-500 rounded-3xl max-w-xl w-full p-6 space-y-4 text-stone-100 shadow-2xl animate-fadeIn">
            <div className="flex items-center justify-between border-b border-stone-800 pb-3">
              <div className="flex items-center space-x-2">
                <Sprout className="w-5 h-5 text-emerald-400" />
              ...
              <button onClick={() => setShowPostCropModal(false)} className="p-1 text-stone-400 hover:text-white">
                <X className="w-5 h-5" />
              </button>
            </div>
            ...
            <form onSubmit={handlePostCropSubmit} className="space-y-3.5 text-xs">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                <div>
                  <label className="block text-stone-300 font-bold mb-1">फसल का नाम (Crop Name)</label>
                  <input
                    type="text"
                    required
                    value={cropForm.cropName}
                    onChange={(e) => setCropForm({ ...cropForm, cropName: e.target.value })}
                    className="w-full bg-stone-900 border border-stone-700 rounded-xl px-3 py-2 text-white font-medium focus:ring-2 focus:ring-emerald-500 outline-none"
                    placeholder="e.g. Sharbati Wheat, Mustard"
                  />
                </div>
                <div>
                  <label className="block text-stone-300 font-bold mb-1">किस्म / वैरायटी (Variety)</label>
                  <input
                    type="text"
                    required
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  <label className="block text-stone-300 font-bold mb-1">मात्रा (Quintals)</label>
                  <input
                    type="number"
                    required
                    min="1"
                    ...
                    className="w-full bg-stone-900 border border-stone-700 rounded-xl px-3 py-2 text-white font-mono font-bold focus:ring-2 focus:ring-emerald-500 outline-none"
                  />
                </div>
                <div>
                  <label className="block text-stone-300 font-bold mb-1">अपेक्षित मूल्य (₹/Quintal)</label>
                  <input
                    type="number"
                    required
                    min="1"
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  <label className="block text-stone-300 font-bold mb-1">गाँव / स्थान (Village)</label>
                  <input
                    type="text"
                    required
                ...
                <div>
                  <label className="block text-stone-300 font-bold mb-1">संपर्क मोबाइल (Phone)</label>
                  <input
                    type="text"
                    required
              ...
              <div>
                <label className="block text-stone-300 font-bold mb-1">फसल विवरण (Produce Description)</label>
                <textarea
                  rows="2"
                  value={cropForm.description}
                  onChange={(e) => setCropForm({ ...cropForm, description: e.target.value })}
                  className="w-full bg-stone-900 border border-stone-700 rounded-xl px-3 py-2 text-white text-xs outline-none"
              ...
              <div className="flex items-center justify-end space-x-2 pt-2 border-t border-stone-800">
                <button
                  ...
                  className="px-4 py-2 bg-stone-800 text-stone-300 rounded-xl hover:bg-stone-700 font-bold"
                >
                  Cancel
                </button>
                <button
                  ...
                  className="px-5 py-2 bg-emerald-600 hover:bg-emerald-500 text-white font-black rounded-xl shadow-lg flex items-center space-x-1.5"
                >
        ...
        <div className="fixed inset-0 z-50 bg-black/80 flex items-center justify-center p-4 backdrop-blur-sm">
          <div className="bg-stone-950 border-2 border-amber-500 rounded-3xl max-w-lg w-full p-6 space-y-4 text-stone-100 shadow-2xl animate-fadeIn">
            <div className="flex items-center justify-between border-b border-stone-800 pb-3">
              ...
              <button onClick={() => setShowTransportModal(false)} className="p-1 text-stone-400 hover:text-white">
                <X className="w-5 h-5" />
              </button>
            </div>
            ...
            <div className="space-y-3 text-xs">
              <div>
                <label className="block text-stone-300 font-bold mb-1">फसल / भार (Cargo & Weight)</label>
                <input
                  type="text"
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  <label className="block text-stone-300 font-bold mb-1">खेत उठाव (Pickup)</label>
                  <input
                    type="text"
                ...
                <div>
                  <label className="block text-stone-300 font-bold mb-1">गंतव्य मंडी (Drop Location)</label>
                  <input
                    type="text"
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  <label className="block text-stone-300 font-bold mb-1">वाहन प्रकार (Vehicle)</label>
                  <select
                ...
                <div>
                  <label className="block text-stone-300 font-bold mb-1">प्रस्तावित भाड़ा (Budget ₹)</label>
                  <input
                    type="number"
        ...
        <div className="fixed inset-0 z-50 bg-black/80 flex items-center justify-center p-4 backdrop-blur-sm">
          <div className="bg-stone-950 border-2 border-emerald-500 rounded-3xl max-w-lg w-full p-6 space-y-4 text-stone-100 shadow-2xl animate-fadeIn">
            <div className="flex items-center justify-between border-b border-stone-800 pb-3">
              ...
              <button onClick={() => setShowMachineryModal(false)} className="p-1 text-stone-400 hover:text-white">
                <X className="w-5 h-5" />
              </button>
            </div>
            ...
            <div className="space-y-3 text-xs">
              <div>
                <label className="block text-stone-300 font-bold mb-1">यंत्र का प्रकार (Machinery Type)</label>
                <select
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  <label className="block text-stone-300 font-bold mb-1">खेत का क्षेत्रफल (Acres)</label>
                  <input
                    type="number"
                ...
                <div>
                  <label className="block text-stone-300 font-bold mb-1">आवश्यक तारीख (Date)</label>
                  <input
                    type="date"
      ...
      {showLabourModal && (
        <div className="fixed inset-0 z-50 bg-black/80 flex items-center justify-center p-4 backdrop-blur-sm">
          <div className="bg-stone-950 border-2 border-blue-500 rounded-3xl max-w-lg w-full p-6 space-y-4 text-stone-100 shadow-2xl animate-fadeIn">
            <div className="flex items-center justify-between border-b border-stone-800 pb-3">
              <div className="flex items-center space-x-2">
              ...
              <button onClick={() => setShowLabourModal(false)} className="p-1 text-stone-400 hover:text-white">
                <X className="w-5 h-5" />
              </button>
            </div>
            ...
            <div className="space-y-3 text-xs">
              <div>
                <label className="block text-stone-300 font-bold mb-1">कार्य का प्रकार (Work Type)</label>
                <input
                  type="text"
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  <label className="block text-stone-300 font-bold mb-1">मजदूरों की संख्या (Count)</label>
                  <input
                    type="number"
                ...
                <div>
                  <label className="block text-stone-300 font-bold mb-1">दैनिक दिहाड़ी (₹/Day/Worker)</label>
                  <input
                    type="number"
            ...
            <div className="flex items-center justify-end space-x-2 pt-2 border-t border-stone-800">
              ...
              <button
                ...
                className="px-5 py-2 bg-blue-600 hover:bg-blue-500 text-white font-black rounded-xl shadow-lg"
              >
      ...
      {showProblemModal && (
        <div className="fixed inset-0 z-50 bg-black/80 flex items-center justify-center p-4 backdrop-blur-sm">
          <div className="bg-stone-950 border-2 border-rose-500 rounded-3xl max-w-lg w-full p-6 space-y-4 text-stone-100 shadow-2xl animate-fadeIn">
            <div className="flex items-center justify-between border-b border-stone-800 pb-3">
              <div className="flex items-center space-x-2">
                <AlertTriangle className="w-5 h-5 text-rose-400" />
                <h3 className="font-black text-lg text-white">
            ...
            <form onSubmit={handleReportProblem} className="space-y-3 text-xs">
              <div>
                <label className="block text-stone-300 font-bold mb-1">समस्या का शीर्षक (Title)</label>
                <input
                  type="text"
                  required
        ...
        <div className="fixed inset-0 z-50 bg-black/85 flex items-center justify-center p-4 backdrop-blur-md">
          <div className="bg-stone-950 border-4 border-red-600 rounded-3xl max-w-lg w-full p-6 space-y-4 text-stone-100 shadow-2xl animate-bounce-short">
            ...
            <form onSubmit={handleEmergencyBroadcast} className="space-y-3.5 text-xs">
              <div>
                <label className="block text-red-300 font-black mb-1 uppercase tracking-wider">
              ...
              <div>
                <label className="block text-stone-300 font-bold mb-1">स्थिति का विवरण (Urgent Situation)</label>
                <textarea
                  rows="3"
                  required
              ...
              <div className="p-3 bg-red-950/80 rounded-2xl border border-red-600/50 text-[11px] text-red-200">
                🚨 This will immediately trigger SMS/Push notifications to the nearest <strong>MANDI Village Mitra</strong>, Panchayat Secretary, and 10+ local community volunteers.
              </div>
        ...
        <div className="fixed inset-0 z-50 bg-black/80 flex items-center justify-center p-4 backdrop-blur-sm">
          <div className="bg-stone-950 border-2 border-amber-500 rounded-3xl max-w-md w-full p-6 space-y-4 text-stone-100 shadow-2xl animate-fadeIn">
            <div className="flex items-center justify-between border-b border-stone-800 pb-3">
              ...
              <button onClick={() => setShowNegotiationModal(false)} className="p-1 text-stone-400 hover:text-white">
                <X className="w-5 h-5" />
              </button>
            </div>
            ...
            <div className="space-y-3 text-xs">
              <div className="p-3 bg-stone-900 rounded-2xl border border-stone-800 space-y-1">
                <span className="text-[10px] text-stone-300 block">Buyer: {selectedDemandOrInquiry.buyerName}</span>
                <span className="font-bold text-white text-sm block">{selectedDemandOrInquiry.cropRequired}</span>
                <span className="text-emerald-400 font-mono font-bold">Buyer Offered: ₹{selectedDemandOrInquiry.budgetPerQuintal} /Qtl</span>
              </div>

              <div>
                <label className="block text-stone-300 font-bold mb-1">आपका प्रति-प्रस्ताव (Your Counter Price ₹/Qtl)</label>
                <input
                  type="number"
              ...
              <div>
                <label className="block text-stone-300 font-bold mb-1">संदेश (Message / Delivery Terms)</label>
                <textarea
                  rows="2"
